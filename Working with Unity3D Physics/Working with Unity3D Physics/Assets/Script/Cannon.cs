...
{   
    ...
    void FixedUpdate () {
        ...
        GameObject projectile = Instantiate(projectilePrefab, transform.position, transform.rotation) as
        GameObject;
    ...
    void LateUpdate() {
        ...
        transform.rotation = Quaternion.Euler(yClamped, transform.eulerAngles.y, 
